                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="d-flex justify-content-end">
                            <a href="{{ route('show.kelas.kehadiran', ['id_kelas' => $kelas->id, 'id_jadwal' => $jadwal->id, 'pertemuan' => $item->pertemuan]) }}" class="d-relative ms-auto btn btn-primary btn-sm ml-auto">Detail</a>
                          </div>
                    </div>
                </div>
              </div>
