        ...
        <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="row">
                    <form action="{{ !empty($data) ? url('ubah-jadwal/'.@$data->id.'/update') : url('jadwal/store')}}" method="POST">
                        @csrf
                        @method('POST')
                        <div class="col">
                            <div class="form-group">
                                <label for="" class="form-control-label">Mata Kuliah</label>
                                <select name="id_mata_kuliah_enroll" id="" class="form-control" disabled>
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input class="form-control" required name="jam_selesai" value="{{old('name',@$data->jam_selesai)}}" type="time">
                            </div>
                        </div>
