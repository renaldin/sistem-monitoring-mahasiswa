        ...
        <div class="card mb-5">
          <div class="card-header pb-0">
            <div class="d-flex align-items-center">
              ...
              <a href="{{ route('nilai.generate', ['mata_kuliah' => $matkul->id]) }}" class="d-relative ms-auto btn btn-outline-success btn-sm">Export PDF</a>
            </div>
          </div>
          <div class="card-body">
            <div class="row">
                    ...
                    <table class="table align-items-center mb-0" id="example">
                      ...
                      <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('nilai.show', ['mata_kuliah' => $matkul->id , 'nilai' => $item->id]) }}"><i class='bx bx-sm text-info bx-search-alt'></i></a>
                            </td>
                        </tr>
                        @endforeach
                      </tbody>
