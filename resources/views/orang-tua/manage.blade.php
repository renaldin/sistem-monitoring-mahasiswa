              ...
              <div class="card-body">
                ...
                @if ($errors->any())
                    <div class="alert alert-danger" role="alert">
                        <div class="d-flex">
                        <div>
                            <div class="text-alert" style="color : white">
                    ...
                    <form action="{{ !empty($data) ? url('orang-tua/'.@$data->id.'/update') : url('orang-tua/store')}}" method="POST">
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <Textarea class="form-control" name="address_ortu">{{ old('address_ortu',@$data->address) }}</Textarea>
                            </div>
                        </div>
                        <div class="col">
                            <div class="form-group">
                                <label for="example-text-input" class="form-control-label">No Handphone Orang Tua</label>
                                <input class="form-control" name="phone_number_ortu" value="{{old('phone_number_ortu',@$data->phone_number)}}" type="number">
                            </div>
                        </div>
                        <div class="col">
                            <div class="form-group">
