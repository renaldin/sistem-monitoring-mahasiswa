    ...
    <div class="col-12">
        <div class="card mb-4">
            ...
            <div class="card-header">
              <div class="row">
                <form action="{{ route('mata-kuliah.filter') }}">
                  <div  class="row"> 
                <div class="col-md-3">
                ...
                <table class="table align-items-center mb-0" id="example">
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                          {{ $item->kelas->tahunAjaran->tahun }}
                          {{-- @if($item->kelas->tahunAjaran->semester % 2 === 1) Ganjil @else Genap @endif Tahun {{ $item->kelas->tahunAjaran->tahun }} --}}
                        </td>
                        ...
                        <td>
                            @if($item->mataKuliah->status == 'aktif' && Auth::user()->role->role_name == 'dosen')
                            ...
                            <a href="{{ route('mata-kuliah.delete', ['mata_kuliah' => $item->id]) }}"><i class='bx bx-sm bx-trash text-danger'></i></a>
                            @endif --}}
                            @endif
                        </td>
                    </tr>
