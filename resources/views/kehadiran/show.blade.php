                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <select name="status[{{ $item->id }}]" id="status{{ $item->id }}" class="status form-control">
                                ...
                                {{-- <td>
                                    <input class="form-control" id="time-input" required name="jam_masuk_mahasiswa[{{ $item->id }}]" value="{{old('jam_masuk_mahasiswa',@$item->jam_masuk_mahasiswa)}}" type="time">
                                </td> --}}
                                <td>
                                    {{-- @if ($item->terlambat != 0)
                                    {{ $item->terlambat }} Menit
                                    @endif --}}
                                    <input class="form-control" id="time-input{{ $item->id }}" required name="terlambat[{{ $item->id }}]" value="{{old('terlambat',@$item->terlambat)}}" placeholder="Per menit" type="text">
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
