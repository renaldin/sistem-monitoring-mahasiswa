...
<div class="row">
    <div class="col-12">
        <div class="card mb-4">
            ...
            <form action="{{ route('kelas.filter') }}">
              @else
              
              <form action="{{ route('kelas.filter.admin') }}">
                @endif
              <div  class="row"> 
            ...
            <div class="col-md-3 mt-4">
              ...
              <a class="btn btn-warning" href="/kelas">Reset Filter</a>
            </div>
                ...
                <table class="table align-items-center mb-0" id="example">
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $item->status }}</td>
                        <td>
                            <a href="{{ Auth::user()->role->role_name == 'admin jurusan' ? route('kelas.show', ['kela' => $item->id]) : route('kelas.show.detail', ['id' => $item->id]) }}"><i class='bx bx-sm text-info bx-detail'></i></a>
                            @if (Auth::user()->role->role_name == 'admin jurusan')
                            <a href="{{ route('kelas.edit', ['kela' => $item->id]) }}"><i class='bx bx-sm text-info bx-edit'></i></a>
                            <a href="#" class="delete-btn" data-url="{{ route('kelas.delete', ['kelas' => $item->id]) }}"><i class='bx bx-sm bx-trash text-danger'></i></a>
                            @endif
                        </td>
                    </tr>
                    @endforeach
