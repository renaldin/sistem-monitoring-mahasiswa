        ...
        <div class="card">
            <div class="card-header pb-0">
              <div class="d-flex align-items-center">
                ...
                <a href="{{ route('nilai.tugas.create.kategori', ['id' => $matkul->id]) }}" class="d-relative ms-auto btn btn-outline-primary btn-sm">Tambah</a>
              </div>
            </div>
            <div class="card-body">
                    ...
                    <table class="table align-items-center mb-0" id="example">
                      ...
                      <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('nilai.tugas.detail', ['id_matkul' => $matkul->id , 'id_kategori' => $item->id]) }}"><i class='bx bx-sm text-info bx-search-alt'></i></a>
                            </td>
                        </tr>
                        @endforeach
                      </tbody>
